...
# ============================================================================
# Recomendación: en producción mueve estas credenciales a st.secrets y usa
# contraseñas hasheadas. Se mantienen aquí temporalmente para no romper el
# funcionamiento actual del dashboard.
USUARIOS = {
